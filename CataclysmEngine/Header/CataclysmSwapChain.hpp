...
namespace Cataclysm
{
  ...
  public:
    ...
    CataclysmSwapChain(const CataclysmSwapChain &) = delete;
    CataclysmSwapChain &operator=(const CataclysmSwapChain &) = delete;
    ...
    bool compareSwapChainFormats(const CataclysmSwapChain &swapChain) const
    {
  ...
  private:
    ...
    std::shared_ptr<CataclysmSwapChain> oldSwapChain;
